...
<div id="bodyWrapperSingle" <?php if (get_option("dm_ts_pfolio_layout") == "3 Columns") {echo 'class="nopaddgins"';} ?>>
        <div id="blogWrapFW">
            ...
            <?php } else { ?>
                ...
                <!--DESCRIPTION-->
	                <span class="arnaud-title all">Our Another type portfolio</span>
                    <span class="arnaud-descr all">The team here at Michael A. Kelly has much experience. Click on a picture to read a bio or use the buttons above to view our team by areas of specialization...</span>
                    <?php $terms = get_terms('types');     
                    foreach ( $terms as $term ) {
