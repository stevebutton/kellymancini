...
= 4.4 [2009-12-31] =
* Bug fix with media uploader: With the ’ÄúDeny non-administrators to access the blog’Äôs back-end’Äù option enabled, the Flash version of the Media Uploader returns the maintenance mode page when something is uploaded. This happened when uploading using an admin user.
...
* Bug fix: Maintenance mode splash page was shown when maintenance mode deactivated but option ’ÄúDeny non-administrators to access the blog’Äôs back-end’Äù activated

= 4.2 [2009-02-01] =
* New feature: Optionally use a ’Äò503.php’Äô from within the theme directory for the splash page
* New feature: Optionally deny non-administrators to access the blog’Äôs back-end
...
* New feature: Apply HTTP header ’Äò503 Service Unavailable’Äô to splash page

= 3.1 [2007-08-03] =
* Bug fix: Replaced ’Äú&lt;?’Äù with ’Äú&lt;?php’Äù in line 210
= 3.0 [2007-07-07] =
...
= 2.2 [2007-01-01] =
* Bug fix: As long as the plugin was active the feeds didn’Äôt work although the maintenance mode was not active.
* New feature: Plugin updated to work with Wordpress 2.1

= 2.1 [2006-11-26] =
* New feature: Maintenance Mode can be activated/deactivated in the plugin’Äôs options, for details see comment #35.
