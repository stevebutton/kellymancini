...
?>
        <table class="form-table">
            <tr valign="top">
                <th scope="row"><label for="wpGoogleMaps_name"><?php _e('Location Name:')?></label></th>
                <td>
                    <input type="text" size="40" style="width:95%;" name="wpGoogleMaps[name]" id="wpGoogleMaps_name" />
                </td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="wpGoogleMaps_address"><?php _e('Address:')?></label></th>
                <td>
                    <input type="text" size="40" style="width:95%;" name="wpGoogleMaps[address]" id="wpGoogleMaps_address" />
                </td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="wpGoogleMaps_description"><?php _e('Location Description:')?></label></th>
                <td>
                    <input type="text" size="40" style="width:95%;" name="wpGoogleMaps[description]" id="wpGoogleMaps_description" />
                </td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="wpGoogleMaps_width"><?php _e('Map Width:')?></label></th>
                <td>
                    <input type="text" size="4" name="wpGoogleMaps[width]" id="wpGoogleMaps_width" />
                </td>
            </tr>
            <tr valign="top">
                <th scope="row"><label for="wpGoogleMaps_height"><?php _e('Map Height:')?></label></th>
                <td>
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <label for="wpGoogleMaps_typecontrol">Enable Map Type Controls (Map, Satellite, or Hybrid)</label><br />
                    ...
                    <label for="wpGoogleMaps_directions_to">Display option to get directions <em>to</em> this location.</label><br />
                    ...
                    <label for="wpGoogleMaps_directions_from">Display option from get directions <em>from</em> this location.</label>
                </td>
            </tr>
        </table>
        <p class="submit">
